<template>
  <div style=" overflow-y:scroll;">
    ...
    <el-button type="danger" size="small" style="width: 95px;">删除</el-button>
      ...
      <span class="btn2">
    <el-button type="primary" size="small" style="width: 95px;margin-right: 10px;" v-if="detailList.dealWithFlag" @click="dialogVisible = true">处理</el-button>
...
<el-dialog :visible.sync="dialogVisible2">
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="warning" size="small" style="width: 95px;">导出</el-button>
      ...
      <div >
        <el-steps :active="2" >
          <el-step :title="item.taskName"  icon="el-icon-success" :description="item.dealPersonName+ item.phonenumber+item.dealDeptName" v-for="(item,index) in detailList.qualityDealList" :key="index">
        ...
        <el-steps direction="vertical" :active="1">
          <el-step :title="item.dealingDate +item.dealPersonName " v-for="(item,index) in detailList.qualityDealList" :key="index" :description="item.flowContent">
            <template slot="description" >
              <div class="step-row" v-for="i in item.qualityDealPicList">
                <img :src=path+i.filePath class="imgItem">
              </div>
              <div class="step-row">
                              <div style="float: left">附件：</div>
                              <div class="attachmentDownload" v-for="i in item.qualityDealFileList">
