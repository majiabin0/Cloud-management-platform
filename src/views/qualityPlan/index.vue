  ...
  <div>
    ...
    <div class="app-container">
      <el-form :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true">
        <el-form-item label="质控简述" prop="roleName">
          <el-input
        ...
        <el-form-item label="质控等级" prop="roleKey">
          <el-select
        ...
        <el-form-item label="质控类型" prop="status">
          <el-select
      ...
      <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="质控时段"  width="200" >
          <template slot-scope="scope">
          {{scope.row.startTime}}&nbsp&nbsp至&nbsp&nbsp{{scope.row.planEndTime}}
          </template>
        </el-table-column>
        <el-table-column label="质控简述" prop="qualityPlanInfo" :show-overflow-tooltip="true" width="140">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="text"
        ...
        <el-table-column label="质控等级" prop="qualityPlanLevel" :show-overflow-tooltip="true" width="100" />
        <el-table-column label="质控类型" prop="qualityPlanType" width="100" />
        <el-table-column label="关联施工任务" prop="planConstructList" width="160" />
        <el-table-column label="应用状态" prop="qualityPlanStatus" width="100" >
        </el-table-column>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.getDicts("quality_plan_type").then(response => {
                this.typeData = response.data;
            });
            this.getDicts("quality_plan_level").then(response => {
