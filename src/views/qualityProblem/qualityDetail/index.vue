...
<div style=" overflow-y:scroll;">
  <div class="detailLeft">
    ...
    <el-carousel :interval="4000" type="card" height="200px">
      <el-carousel-item v-for="item in detailList.qualityPicList" :key="item">
<!--        <h3 class="medium">{{ item }}</h3>-->
        <img :src=path+item.filePath style="width: 317px;height: 200px;">
      </el-carousel-item>
    </el-carousel>
...
<el-dialog :visible.sync="dialogVisible2">
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <div >
    <el-steps :active="4" >
      <el-step :title="item.taskName"  icon="el-icon-success" :description="item.dealPersonName+ item.phonenumber+item.dealDeptName" v-for="(item,index) in detailList.qualityDealList" :key="index"></el-step>
<!--      <el-step title="确认事件"  icon="el-icon-success" description="周一一-->
<!--18689897766-->
<!--中科智领(青岛)数字科技有限公司"></el-step>-->
<!--      <el-step title="提醒验收"  icon="el-icon-info" description="周一一-->
<!--18689897766-->
<!--中科智领(青岛)数字科技有限公司"></el-step>-->
<!--      <el-step title="完成验收"  icon="el-icon-info" description="周一一-->
<!--18689897766-->
<!--中科智领(青岛)数字科技有限公司"></el-step>-->
    </el-steps>
    </div>
    <div style="height: 300px;margin-top: 108px;">
      <el-steps direction="vertical" :active="1">
        <el-step :title="item.dealingDate+item.dealPersonName" v-for="(item,index) in detailList.qualityDealList" :key="index" :description="item.flowContent">
          <template slot="description" >
            <div class="step-row">
              <img  v-for="i in item.qualityDealPicList" :src=path+i.filePath class="imgItem" >
            </div>
            <div class="step-row">
              <div style="float: left">附件：</div>
              <div class="attachmentDownload" v-for="i in item.qualityDealList">
...
<!--          </div>-->
<!--        </div>-->
<!--        <el-step title="2020.10.10.06.06   吴天天 确认事件" description="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"></el-step>-->
<!--        <div class="step1">-->
<!--          <div>-->
...
<!--              <div><a>1. XXXXXXXXXXXXX.jpg</a></div>-->
<!--              <div><a>2. XXXXXXXXXXXXX.doc</a></div>-->
<!--              <div><a>3. XXXXXXXXXXXXXX.dwg</a></div>-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
<!--        <el-step title="2020.10.10.06.06   吴天天 确认事件" description="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"></el-step>-->
...
<script>
    import { qualityDetail, complete, addAttachs } from "@/api/qualityControl/qualityControl";
    export default {
        name: "index",
        data(){
          return{
        ...
        methods:{
            ...
            getList() {
                // this.loading = true;
                console.log(this.$route.query.guid,'this.guid')
                this.guid='88ad0f2f-e2ba-4005-8ad6-4430925403c5'
                qualityDetail(this.guid).then(
                    response => {
