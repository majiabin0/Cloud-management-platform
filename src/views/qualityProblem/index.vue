...
<!--            </div>-->
          ...
          <el-col :span="14">
            <div>
              <div id="main1" style="width:270px; height: 190px;">111111111</div>
...
<script>
    ...
    export default {
        ...
        created() {
            this.getData();
            // this.getList();
            this.getDicts("quality_event_type").then(response => {
                this.typeData = response.data;
            });
            this.getDicts("quality_event_level").then(response => {
                this.levelData = response.data;
            });
            this.getDicts("sys_normal_disable").then(response => {
                this.statusOptions = response.data;
            });
            getCountByType({projId:'004',questionType:0}).then(response => {
                console.log(response,'res')
                this.countByType=response.data
            });
            getCountByLevel({projId:'004',questionType:0}).then(response => {
                this.countByLevel=response.data
            });
            getQualityCount({projId:'004',questionType:0}).then(response => {
                console.log(response,'res')
        ...
        methods: {
            ...
            //         this.getCountByWeek1=response.data
            //         console.log(this.getCountByWeek1,'res')
            //         //
            //     });
            // },
            // handleDate2(){
            ...
            getMap() {
                ...
                let option = {
                    xAxis: {
                        type: 'category',
                        // data: this.dataX,
                        data: this.getCountByWeek1.xAxis,
                    ...
                    series: [
                        {
                            // data: this.dataY,
                            data: this.getCountByWeek1.yAxis,
                            type: 'line',
